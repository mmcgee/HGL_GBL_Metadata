...
vectorLoc = '{"wms": ["http://pelham.lib.harvard.edu:8090/geoserver/wms"],"wfs": "http://pelham.lib.harvard.edu:8090/geoserver/wfs"}'
# "DataType": "Paper Map",'Scanned Map', 'Raster'
rasterLoc = '{"wms": ["http://pelham.lib.harvard.edu:8090/geoserver/wms"],"wcs": "http://pelham.lib.harvard.edu:8090/geoserver/wcs","download": "http://pelham.lib.harvard.edu:8080/HGL/HGLOpenDelivery"}'

vectorLocForFile = '{\\\"wms\\": [\\"http://pelham.lib.harvard.edu:8090/geoserver/wms\\"],\\"wfs\\": \\"http://pelham.lib.harvard.edu:8090/geoserver/wfs\\"}'
rasterLocForFile = '{\\\"wms\\": [\\"http://pelham.lib.harvard.edu:8090/geoserver/wms\\"],\\"wcs": \\"http://pelham.lib.harvard.edu:8090/geoserver/wcs\\",\\"download\\": \\"http://pelham.lib.harvard.edu:8080/HGL/HGLOpenDelivery\\"}'
